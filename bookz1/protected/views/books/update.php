...
$this->breadcrumbs = array(
	'Books' => array('index'),
	$book->title => array('view', 'id' => $book->id),
	'Edit',
);
...
<div class="row">
	<div class="col-md-12">
		...
		<p class="text-muted">Editing: <strong><?php echo CHtml::encode($book->title); ?></strong></p>
	</div>
</div>
							...
							<select name="Book[authorIds][]" id="Book_authorIds" class="form-select" multiple size="5" required>
								<?php foreach ($authors as $author): ?>
									<option value="<?php echo $author->id; ?>"
											<?php echo in_array($author->id, $book->authorIds) ? 'selected' : ''; ?>>
					...
					<div class="mb-3">
						...
						<div>
							<img src="<?php echo Yii::app()->request->baseUrl . CHtml::encode($book->cover_image); ?>" 
								 ...
								 class="cover-thumbnail rounded mb-2">
						</div>
